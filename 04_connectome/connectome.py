...
for gsr in ["_gsr",""]:
    for key in keys:
        ...
        atlasfile = CODEDIR+"04_connectome/utils/Parcels_MNI_111.nii"
        subcort_atlasfile = CODEDIR+"04_connectome/utils/HarvardOxford-sub-prob-1mm.nii.gz"
        cerebellum_atlasfile = CODEDIR+"04_connectome/utils/Cerebellum-MNIfnirt-prob-1mm.nii.gz"
